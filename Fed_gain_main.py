...
from Fed_gain_test_run import fed_gain_test_exp, compute_indicator_results, plot_indicator_avg_results_m
...
def fed_main(args, save_path=''):
    ...
    if args.independent_usrs_training:
        ...
        #     local_test_mse = local.testing(local_g, station)
        #     local_mse_test_l.append(local_test_mse.cpu().detach().numpy())
        # save_mse_test_fp = './results/idpt_mse_test_results.csv'
        # save_as_csv(save_mse_test_fp, local_mse_test_l, stations)
...
if __name__ == '__main__':
    ...
    # 做实验
    exp_total_time = 1
    cross_validation_sets = 3

    results_saved_file = 'results_v4'
    results_plot_file = 'plot_results_v4'
    ...
    if training_model == 'Many_time':
        ...
        dataset_name = '(A5_A15_A30)_532r_One_time'
    ...
    for param in params_test_list:
        ...
        exp_name = '{}_latest_lep10_epoch1e4_dlr_kaiminInit-T2'.format(dataset_name)
        ex_params_settings = {
            'algo_name': 'FedWA',
            'WeightAvg_method': 'soft',

...
from WGAN_LocalUpdate import GANUpdate as LocalUpdate  # WGAN
...
if __name__ == '__main__':
    ...
    for param in params_test_list:
        ...
        exp_name = 'wGAI_{}_T3'.format(dataset_number)
        # args.alpha = param
        # exp_name = 'Test{}_P09D3T3_nc1a{}_GAIN_{}'.format(get_time_stamp(), param, dataset_number)
        ex_params_settings = {
            'algo_name': 'wGANI_AQDI',
            'gan_category': args.gan_categories,
